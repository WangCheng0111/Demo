...
import { h, Fragment, defineComponent, ref, createApp, watchEffect } from 'vue';
...
const ImageInput = defineComponent({
  ...
  setup({
    ...
    return () => {
      ...
      ), /* @__PURE__ */ h("label", { class: "uploader", for: fileInputId }, /* @__PURE__ */ h(Icon, { icon: uploadButton })), /* @__PURE__ */ h("span", { class: "text", onClick: () => {
        var _a2;
